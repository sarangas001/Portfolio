...
(function($) {
    ...
    function de_share(){
     ...
     $(function(){
        ...
        $(".d-item").slice(0, 8).show();
         ...
         //--- demo hover ---
         jQuery("#demo_1").on("mouseenter", function() {
             jQuery('section').css("background","#000000");
             jQuery('span,h4').css("color","#ffffff");
         });

         jQuery("#demo_2").on("mouseenter", function() {
             jQuery('section').css("background","#ffffff");
             jQuery('span,h4').css("color","#000000");
         })

         jQuery("#demo_3").on("mouseenter", function() {
             jQuery('section').css("background","#C37D87");
             jQuery('span,h4').css("color","#ffffff");
         })

         jQuery("#demo_4").on("mouseenter", function() {
             jQuery('section').css("background","#C8F418");
             jQuery('span,h4').css("color","#000000");
         })

         jQuery("#demo_5").on("mouseenter", function() {
             jQuery('section').css("background","#000000");
             jQuery('span,h4').css("color","#ffffff");
         })

         jQuery("#demo_6").on("mouseenter", function() {
             jQuery('section').css("background","#E04B18");
             jQuery('span,h4').css("color","#ffffff");
         })

          jQuery("#demo_7").on("mouseenter", function() {
             jQuery('section').css("background","#b8fe65");
             jQuery('span,h4').css("color","#000000");
         })

           jQuery("#demo_8").on("mouseenter", function() {
              jQuery('section').css("background","#000000");
              jQuery('span,h4').css("color","#ffffff");
          })

           jQuery("#demo_9").on("mouseenter", function() {
              jQuery('section').css("background","#df4a34");
              jQuery('span,h4').css("color","#ffffff");
          })

           jQuery("#demo_10").on("mouseenter", function() {
              jQuery('section').css("background","#390099");
              jQuery('span,h4').css("color","#ffffff");
          })

         jQuery(".demo-dark-scheme").on("mouseenter", function() {
             jQuery('section').css("background","#000000");
             jQuery('span,h4').css("color","#ffffff");
         })
    ...
    $(window).on('load', function() {
        ...
        jQuery('.text-fit').addClass("fadeInDown");
        jQuery('.d-menu-1').addClass("fadeInDown");
        filter_gallery();
        load_owl();  
